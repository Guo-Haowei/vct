...
bool initialize() {
    ...
    const std::string preload[] = {
        "@resource://fonts/DroidSans.ttf",
        "@resource://glsl/vsinput.glsl.h",
        "@resource://glsl/cbuffer.glsl.h",
        "@resource://glsl/common.glsl",
        "@resource://glsl/mesh_static.vert",
        "@resource://glsl/mesh_animated.vert",
        "@resource://glsl/depth_static.vert",
        "@resource://glsl/depth_animated.vert",
        "@resource://glsl/depth.frag",
        "@resource://glsl/fullscreen.vert",
        "@resource://glsl/fxaa.frag",
        "@resource://glsl/gbuffer.frag",
        "@resource://glsl/pbr.glsl",
        "@resource://glsl/shadow.glsl",
        "@resource://glsl/ssao.frag",
        "@resource://glsl/textureCB.glsl",
        "@resource://glsl/vct_deferred.frag",
        "@resource://glsl/debug/texture.frag",
        "@resource://glsl/editor/image.vert",
        "@resource://glsl/editor/image.frag",
        "@resource://glsl/voxel/voxelization.vert",
        "@resource://glsl/voxel/voxelization.geom",
        "@resource://glsl/voxel/voxelization.frag",
        "@resource://glsl/voxel/post.comp",
    };
