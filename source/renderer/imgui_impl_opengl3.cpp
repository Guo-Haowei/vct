...
bool ImGui_ImplOpenGL3_CreateDeviceObjects(unsigned int shaderHandle)
{
    ...
    g_ShaderHandle = shaderHandle;

    g_AttribLocationTex = glGetUniformLocation(g_ShaderHandle, "u_texture");
    g_AttribLocationProjMtx = glGetUniformLocation(g_ShaderHandle, "u_projection");
